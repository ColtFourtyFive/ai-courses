# Capstone · Capstone: Build Something Real
**Owner:** Osman  ·  **Status:** Partial (re-level)  ·  **Emotional target:** the "spring," made visible
...
- **Covers:** pick an ambitious real thing; define what "good" looks like; build the smallest version that works; test it; note its limits; **demo day**. Concept seeded in Module 0 or 1; learners commit to their specific project at end of Part 1 (after Module 4); building spans Parts 2–4.
...
_(fill only the blocks the spec lists; pull research from research-notes/module-capstone.md; pull repurpose material from sources/Source-Material-Library.md)_
