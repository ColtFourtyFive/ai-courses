# Working Notes — Inter-Team Logistics

> This file contains inter-team logistics: build order, review cadence, input handoffs, and ownership rationale.
> It is NOT a source-of-truth file for course content. Do NOT include it in agent briefings.
> Source-of-truth files for agents: AGENTS.md, Curriculum.md, Format-and-Delivery.md, Master-Build-Plan.md, Source-Material-Library.md.

---

## How we're splitting the work
...
**Settled decisions (Section 2 of Master-Build-Plan):** de-vendor level, scenario swap, audience band, platform, format, labs, capstone timing — all locked. No need to settle before starting.
...
## Build order (from Curriculum.md)
